...
public class OllamaModelClient extends ModelClient {
    public OllamaModelClient(ModelData modelData, OllamaModelConfiguration configuration, ModelClientConfiguration clientConfiguration) {
