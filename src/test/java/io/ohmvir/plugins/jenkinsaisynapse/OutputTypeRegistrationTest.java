...
public class OutputTypeRegistrationTest {
    ...
    public void testOutputTypeRegistration(JenkinsRule j){
        assertFalse(
                InputTypeRegistrationTest.getAllSubclasses(ModelOutput.class)
                        .stream()
        ...
        assertFalse(InputTypeRegistrationTest.getAllSubclasses(ModelOutput.class)
                .stream()
                .anyMatch(
                        subclass -> ModelRequest.getRequiredOutputCapabilities(subclass).isEmpty()
